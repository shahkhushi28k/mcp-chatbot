...
If a tool is needed, call exactly one available tool.
Do not output XML tags, function tags, markdown, or explanatory text before the tool call.
Use only the tool schema arguments.
After the tool result is returned, answer briefly and clearly.
"""
...
if "initialized" not in st.session_state:
    ...
    st.session_state.llm = ChatGroq(
        model="llama-3.3-70b-versatile",  # or mixtral / llama3
        temperature=0
    )
